        ...
        <div class="row justify-content-center">
            <div class="col-12 mb-3">
                <div class="card">
                    ...
                    <div class="row g-0">
                        <div class="col-md-4">
                            <img src="{{ isset(Auth::user()->profile_picture)? asset('storage/profile-picture/' . Auth::user()->profile_picture): asset('storage/profile-picture/default-profile.jpg') }}"
                                class="img-fluid rounded-start" alt="..." id="profile-img">
                            <div class="">
                                <button id="profile-picture-button" class="btn btn-primary w-100"><i class="fas fa-edit"
                                        form="profile-picture-form"></i>
                                    Change
                                    Profile
                                    Picture
                                </button>
                                ...
                                <div class="">
                                    <form action="{{ route('profile.update') }}" class="" method="post"
                                        ...
                                        <div style="">
                                            ...
                                            <textarea name="bio" id="bio" cols="30" rows="7" class="form-control mb-2">{{ old('bio') ? old('bio') : (Auth::user()->bio ? Auth::user()->bio : 'Add your bio here ...') }}
                                            </textarea>
                                            @error('bio')
                                                <span class="text-danger">{{ $message }}</span>
                                            @enderror
